...
subplot(2,2,1), plot(2:8, avg_sil), title('Average Silhouette')
subplot(2,2,2), bar(2:8, cluster_consistency), colormap('jet')
subplot(2,2,3), plot(3:8, VI), title('Variation of Information')
subplot(2,2,4), plot(3:8, HI), title('Hierarchy Index'), hold on, plot(3:8, median(HI)*ones(1,length(HI)), '--')

save('metrics.mat', 'avg_sil', 'cluster_consistency', 'VI', 'HI');
